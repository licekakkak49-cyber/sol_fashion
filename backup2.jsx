              ...
              <div className={styles.desktopContainer}>
                ...
                {!query.trim() ? (
                  ...
                  <div className={styles.desktopAfterSearch}>
                    ...
                    <div className={styles.section} style={{ marginBottom: finalResults.length > 0 ? '0' : '40px'}}>
                      {finalResults.length > 0 ? (
                        <div className={styles.searchResultsGrid}>
                          {finalResults.slice(0, 12).map(product => (
                    ...
                    {finalResults.length > 0 && (
                      <div className={styles.seeResultsBtnWrapper}>
                        <button className={styles.seeResultsBtn} onClick={() => { onClose(); navigate('/products'); }}>
                          SEE THE RESULTS ({finalResults.length})
                        </button>
                      </div>
                    )}
                  </div>
                ...
                {!query.trim() ? (
                  ...
                  <>
                    ...
                    <div className={styles.section} style={{ marginBottom: finalResults.length > 0 ? '0' : '40px'}}>
                      {finalResults.length > 0 ? (
                        <div className={styles.searchResultsGrid}>
                          {finalResults.slice(0, 4).map(product => (
                            <div key={product.id} className={styles.productCard} onClick={onClose}>
                              <ProductCard
                                id={product.id}
                                image={product.image}
