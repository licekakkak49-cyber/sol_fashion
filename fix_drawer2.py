...
# Let's completely rewrite the form content to be safe and clean!

start_marker = "          <form id=\"homepage-editor-form\" onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>"
end_marker = "          </form>"
...
pattern = r"(<form id=\"homepage-editor-form\" onSubmit=\{handleSubmit\} style=\{\{ display: 'flex', flexDirection: 'column', gap: '20px' \}\}>).*?(</form>)"
code = re.sub(pattern, r"\1" + form_content + r"\n\2", code, flags=re.DOTALL)
