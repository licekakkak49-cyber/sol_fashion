...
const HeroBlockEditor = ({ module, updateData }) => {
  const { data } = module;
    ...
    <>
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: '18px', letterSpacing: '0.05em' }}>Change Full Hero Image</span>
        </div>
      ...
      {cropImageSrc && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 99999 }}>
          <ImageCropper 
            ...
            onCropComplete={(c) => { updateData({ ...data, bgImage: c }); setCropImageSrc(null); }}
